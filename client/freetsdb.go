// use github.com/freetsdb/freetsdb/client/v2 instead.
package client // import "github.com/freetsdb/freetsdb/client"
...
const (
	// DefaultHost is the default host used to connect to an FreeTSDB instance
	DefaultHost = "localhost"

	// DefaultPort is the default port used to connect to an FreeTSDB instance
	DefaultPort = 8086

	// DefaultTimeout is the default connection timeout used to connect to an FreeTSDB instance
	DefaultTimeout = 0
)
...
// UserAgent: If not provided, will default "FreeTSDBClient",
...
func NewClient(c Config) (*Client, error) {
	...
	if client.userAgent == "" {
		client.userAgent = "FreeTSDBClient"
	}
	return &client, nil
}
...
// checkPointTypes ensures no unsupported types are submitted to freetsdb, returning error if they are found.
