...
func TestService_CreatesDatabase(t *testing.T) {
	...
	s.MetaClient.CreateDatabaseWithRetentionPolicyFn = func(name string, _ *meta.RetentionPolicyInfo) (*meta.DatabaseInfo, error) {
...
func NewTestService(c *Config) *TestService {
	...
	service.MetaClient.CreateRetentionPolicyFn = func(string, *meta.RetentionPolicyInfo, bool) (*meta.RetentionPolicyInfo, error) {
		return nil, nil
	}

	service.MetaClient.CreateDatabaseWithRetentionPolicyFn = func(string, *meta.RetentionPolicyInfo) (*meta.DatabaseInfo, error) {
		return nil, nil
	}
