...
`, &c); err != nil {
	...
	if got, exp := c.Dir, "/var/lib/freetsdb/data"; got != exp {
		t.Errorf("unexpected dir:\n\nexp=%v\n\ngot=%v\n\n", exp, got)
	}
	if got, exp := c.WALDir, "/var/lib/freetsdb/wal"; got != exp {
