...
func TestEngine_WritePoints_TypeConflict(t *testing.T) {
	os.Setenv("FREETSDB_SERIES_TYPE_CHECK_ENABLED", "1")
	defer os.Unsetenv("FREETSDB_SERIES_TYPE_CHECK_ENABLED")
...
func TestEngine_WritePoints_Reload(t *testing.T) {
	t.Skip("Disabled until FREETSDB_SERIES_TYPE_CHECK_ENABLED is enabled by default")
