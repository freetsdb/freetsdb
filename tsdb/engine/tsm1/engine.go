...
package tsm1 // import "github.com/freetsdb/freetsdb/tsdb/engine/tsm1"
...
import (
	...
	"github.com/freetsdb/freetsdb/pkg/estimator"
	"github.com/freetsdb/freetsdb/pkg/file"
	"github.com/freetsdb/freetsdb/pkg/limiter"
	"github.com/freetsdb/freetsdb/pkg/metrics"
	"github.com/freetsdb/freetsdb/pkg/radix"
	intar "github.com/freetsdb/freetsdb/pkg/tar"
	"github.com/freetsdb/freetsdb/pkg/tracing"
	"github.com/freetsdb/freetsdb/query"
	"github.com/freetsdb/freetsdb/tsdb"
	_ "github.com/freetsdb/freetsdb/tsdb/index"
	"github.com/freetsdb/freetsdb/tsdb/index/inmem"
...
func NewEngine(id uint64, idx tsdb.Index, path string, walPath string, sfile *tsdb.SeriesFile, opt tsdb.EngineOptions) tsdb.Engine {
	...
	if os.Getenv("FREETSDB_SERIES_TYPE_CHECK_ENABLED") != "" {
