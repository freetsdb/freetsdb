...
func Test_Client_RegistrationURL(t *testing.T) {
	...
	r.Equal("https://usage.freetsdb.org/start?cluster_id=clus1&product=chronograf&redirect_url=http%3A%2F%2Fexample.com", u)
}
...
func Example_registrationURL() {
	...
	fmt.Printf("s: %s\n", s)
	// https://usage.freetsdb.org/start?cluster_id=clus1&product=chronograf&redirect_url=http%3A%2F%2Fexample.com
}
