...
// Command represents the program execution for "freets_inspect verify-seriesfile".
type Command struct {
	Stdout io.Writer
	Stderr io.Writer
...
func (cmd *Command) Run(args ...string) error {
	...
	fs.StringVar(&cmd.dir, "dir", filepath.Join(os.Getenv("HOME"), ".freetsdb", "data"),
		"Data directory.")
...
Usage: freets_inspect verify-seriesfile [flags]

    -dir <path>
            Root data path.
            Defaults to "%[1]s/.freetsdb/data".
    -db <name>
