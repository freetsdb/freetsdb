// Package help contains the help for the freets_inspect command.
package help
...
const usage = `
Usage: freets_inspect [[command] [arguments]]
...
Use "freets_inspect [command] -help" for more information about a command.
`
