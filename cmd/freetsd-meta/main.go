// Command freetsd-meta is the FreeTSDB server.
package main
...
func (m *Main) Run(args ...string) error {
	...
	default:
		return fmt.Errorf(`unknown command "%s"`+"\n"+`Run 'freetsd-meta help' for usage`+"\n\n", name)
	}

	return nil
}

// VersionCommand represents the command executed by "freetsd-meta version".
