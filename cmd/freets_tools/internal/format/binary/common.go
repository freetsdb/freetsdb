...
//go:generate protoc -I$GOPATH/src/github.com/freetsdb/freetsdb/vendor -I. --gogofaster_out=Mgoogle/protobuf/empty.proto=github.com/gogo/protobuf/types:. binary.proto
