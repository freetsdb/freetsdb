// Package tsdb abstracts the various shard types supported by the freets_tsm command.
package tsdb // import "github.com/freetsdb/freetsdb/cmd/freets_tsm/tsdb"
