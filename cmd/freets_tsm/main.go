// Command freets_tsm converts b1 or bz1 shards (from FreeTSDB releases earlier than v0.11)
...
import (
	...
	"github.com/freetsdb/freetsdb/cmd/freets_tsm/b1"
	"github.com/freetsdb/freetsdb/cmd/freets_tsm/bz1"
	"github.com/freetsdb/freetsdb/cmd/freets_tsm/tsdb"
)
...
func main() {
	...
	if opts.Parallel {
		if !isEnvSet("GOMAXPROCS") {
			...
			// This means 'GOMAXPROCS=1 freets_tsm -parallel' will not actually
			// run in parallel
