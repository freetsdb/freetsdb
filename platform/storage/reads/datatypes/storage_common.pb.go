...
type ReadRequest struct {
	...
	//
	Group ReadRequest_Group `protobuf:"varint,11,opt,name=group,proto3,enum=freetsdb.platform.storage.ReadRequest_Group" json:"group,omitempty"`
...
type Aggregate struct {
	Type                 Aggregate_AggregateType `protobuf:"varint,1,opt,name=type,proto3,enum=freetsdb.platform.storage.Aggregate_AggregateType" json:"type,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                `json:"-"`
	XXX_sizecache        int32                   `json:"-"`
}
...
type ReadResponse_SeriesFrame struct {
	...
	DataType             ReadResponse_DataType `protobuf:"varint,2,opt,name=data_type,json=dataType,proto3,enum=freetsdb.platform.storage.ReadResponse_DataType" json:"data_type,omitempty"`
	XXX_NoUnkeyedLiteral struct{}              `json:"-"`
	XXX_sizecache        int32                 `json:"-"`
}
...
func init() {
	proto.RegisterType((*ReadRequest)(nil), "freetsdb.platform.storage.ReadRequest")
	proto.RegisterMapType((map[string]string)(nil), "freetsdb.platform.storage.ReadRequest.TraceEntry")
	proto.RegisterType((*Aggregate)(nil), "freetsdb.platform.storage.Aggregate")
	proto.RegisterType((*Tag)(nil), "freetsdb.platform.storage.Tag")
	proto.RegisterType((*ReadResponse)(nil), "freetsdb.platform.storage.ReadResponse")
	proto.RegisterType((*ReadResponse_Frame)(nil), "freetsdb.platform.storage.ReadResponse.Frame")
	proto.RegisterType((*ReadResponse_GroupFrame)(nil), "freetsdb.platform.storage.ReadResponse.GroupFrame")
	proto.RegisterType((*ReadResponse_SeriesFrame)(nil), "freetsdb.platform.storage.ReadResponse.SeriesFrame")
	proto.RegisterType((*ReadResponse_FloatPointsFrame)(nil), "freetsdb.platform.storage.ReadResponse.FloatPointsFrame")
	proto.RegisterType((*ReadResponse_IntegerPointsFrame)(nil), "freetsdb.platform.storage.ReadResponse.IntegerPointsFrame")
	proto.RegisterType((*ReadResponse_UnsignedPointsFrame)(nil), "freetsdb.platform.storage.ReadResponse.UnsignedPointsFrame")
	proto.RegisterType((*ReadResponse_BooleanPointsFrame)(nil), "freetsdb.platform.storage.ReadResponse.BooleanPointsFrame")
	proto.RegisterType((*ReadResponse_StringPointsFrame)(nil), "freetsdb.platform.storage.ReadResponse.StringPointsFrame")
	proto.RegisterType((*CapabilitiesResponse)(nil), "freetsdb.platform.storage.CapabilitiesResponse")
	proto.RegisterMapType((map[string]string)(nil), "freetsdb.platform.storage.CapabilitiesResponse.CapsEntry")
	proto.RegisterType((*HintsResponse)(nil), "freetsdb.platform.storage.HintsResponse")
	proto.RegisterType((*TimestampRange)(nil), "freetsdb.platform.storage.TimestampRange")
	proto.RegisterEnum("freetsdb.platform.storage.ReadRequest_Group", ReadRequest_Group_name, ReadRequest_Group_value)
	proto.RegisterEnum("freetsdb.platform.storage.ReadRequest_HintFlags", ReadRequest_HintFlags_name, ReadRequest_HintFlags_value)
	proto.RegisterEnum("freetsdb.platform.storage.Aggregate_AggregateType", Aggregate_AggregateType_name, Aggregate_AggregateType_value)
	proto.RegisterEnum("freetsdb.platform.storage.ReadResponse_FrameType", ReadResponse_FrameType_name, ReadResponse_FrameType_value)
	proto.RegisterEnum("freetsdb.platform.storage.ReadResponse_DataType", ReadResponse_DataType_name, ReadResponse_DataType_value)
}
...
func (c *storageClient) Read(ctx context.Context, in *ReadRequest, opts ...grpc.CallOption) (Storage_ReadClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Storage_serviceDesc.Streams[0], "/freetsdb.platform.storage.Storage/Read", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *storageClient) Capabilities(ctx context.Context, in *types.Empty, opts ...grpc.CallOption) (*CapabilitiesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/freetsdb.platform.storage.Storage/Capabilities", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storageClient) Hints(ctx context.Context, in *types.Empty, opts ...grpc.CallOption) (*HintsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/freetsdb.platform.storage.Storage/Hints", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Storage_Capabilities_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/freetsdb.platform.storage.Storage/Capabilities",
	}
...
func _Storage_Hints_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/freetsdb.platform.storage.Storage/Hints",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Storage_serviceDesc = grpc.ServiceDesc{
	ServiceName: "freetsdb.platform.storage.Storage",
