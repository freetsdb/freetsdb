...
type Node struct {
	NodeType Node_Type `protobuf:"varint,1,opt,name=node_type,json=nodeType,proto3,enum=freetsdb.platform.storage.Node_Type" json:"nodeType"`
...
type Node_Logical_ struct {
	Logical Node_Logical `protobuf:"varint,11,opt,name=logical,proto3,enum=freetsdb.platform.storage.Node_Logical,oneof"`
}
type Node_Comparison_ struct {
	Comparison Node_Comparison `protobuf:"varint,12,opt,name=comparison,proto3,enum=freetsdb.platform.storage.Node_Comparison,oneof"`
}
...
func init() {
	proto.RegisterType((*Node)(nil), "freetsdb.platform.storage.Node")
	proto.RegisterType((*Predicate)(nil), "freetsdb.platform.storage.Predicate")
	proto.RegisterEnum("freetsdb.platform.storage.Node_Type", Node_Type_name, Node_Type_value)
	proto.RegisterEnum("freetsdb.platform.storage.Node_Comparison", Node_Comparison_name, Node_Comparison_value)
	proto.RegisterEnum("freetsdb.platform.storage.Node_Logical", Node_Logical_name, Node_Logical_value)
}
