...
package diagnostics // import "github.com/freetsdb/freetsdb/monitor/diagnostics"
...
// the values for each column, by row. This information is never written to an FreeTSDB
